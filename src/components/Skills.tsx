    ...
    <div className="flex flex-col justify-center items-center mt-32 space-y-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-20">
        {skills.skills.map((skill, index) => (
          <div
            key={index}
            className="w-72 h-auto p-5 pt-20 space-y-5 flex flex-col items-center bg-[#e6e3e3] dark:bg-[#222121] rounded-xl hover:bg-white dark:hover:bg-black transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-500"
          >
            <Image
              src={skill.logo}
              height={60}
